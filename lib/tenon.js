 ...
 * Options includes any of the options documented by Tenon, plus:
 *   - userid and password. If present, the url parameter is assumed to be remote
 *     and userid and password are incorporated for basic auth.
...
module.exports = function(opts, callback) {
   ...
   * If userid and password are both present, incorporate them in the (assumed)
